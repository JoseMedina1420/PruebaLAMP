...
$sql = "SELECT id, nombre, descripcion, talla, precio, stock, imagen FROM playera_adulto LIMIT $limit OFFSET $offset";
...
$totalProductosResult = $conn->query("SELECT COUNT(*) as total FROM playera_adulto");
